...
var Stats = function () {
    ...
    i.id = "fpsText";
    i.style.cssText = "color:#0ff;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bo" +
            "ld;line-height:15px";
    i.innerHTML = "FPS";
    a.appendChild(i);
    ...
    k.id = "msText";
    k.style.cssText = "color:#0f0;font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bo" +
            "ld;line-height:15px";
    k.innerHTML = "MS";
    d.appendChild(k);
